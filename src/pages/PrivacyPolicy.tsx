...
const PrivacyPolicy = () => {
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 sm:py-20 px-4 bg-gradient-to-b from-background to-muted/20">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <Card className="p-4 sm:p-6 lg:p-8">
              <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-3 sm:mb-4">Introduction</h2>
            ...
            <Card className="p-4 sm:p-6 lg:p-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-2 sm:mb-3">Personal Information</h3>
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-2 sm:mb-3">Learning Data</h3>
                  <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1 sm:space-y-2 ml-2 sm:ml-4">
                ...
                <div>
                  <h3 className="text-lg sm:text-xl font-semibold text-foreground mb-2 sm:mb-3">Technical Information</h3>
                  <ul className="list-disc list-inside text-sm sm:text-base text-muted-foreground space-y-1 sm:space-y-2 ml-2 sm:ml-4">
